    ...
    <body>
      ...
      <div class="info-grid">
        <div class="info-box">
          ...
          <div class="info-row">
            ...
            <span class="info-value"><strong>${data.proveedor}</strong></span>
          </div>
        </div>
        <div class="info-box">
          ...
          <div class="info-row">
            ...
            <span class="info-value">${data.obraNombre}</span>
          </div>
          <div class="info-row">
            <span class="info-label">Forma de Pago:</span>
            <span class="info-value">${data.formaPago || "Transferencia"}</span>
          </div>
          <div class="info-row">
            <span class="info-label">Condiciones:</span>
            <span class="info-value">${data.diasCredito > 0 ? data.diasCredito + " días crédito" : "Contado"}</span>
          </div>
      ...
      <table class="totals">
        <tr>
          ...
          <td style="text-align:right;width:120px">$${subtotal.toLocaleString("es-MX", { minimumFractionDigits: 2 })}</td>
        </tr>
        <tr>
          <td style="text-align:right">IVA 16%:</td>
          <td style="text-align:right">$${iva.toLocaleString("es-MX", { minimumFractionDigits: 2 })}</td>
        </tr>
        <tr>
      ...
      <div class="notes">
        ...
        • Favor de enviar factura a: administracion@gcuavante.com<br>
        • Entregar en obra: ${data.obraNombre}<br>
        • Incluir copia de esta orden con el material
      </div>

      <div class="footer">
        <div class="firma">
          <div class="firma-line">Elaboró</div>
          <div style="font-size:9px;color:#666">Depto. Compras</div>
        </div>
        <div class="firma">
          <div class="firma-line">Autorizó</div>
          <div style="font-size:9px;color:#666">Dirección General</div>
        </div>
        <div class="firma">
