...
export default function AlertasGlobales() {
  ...
  if (minimizado) {
    return (
      <button
        ...
        className="fixed bottom-6 left-60 z-[9999] flex items-center gap-1 px-3 py-1.5 rounded-full text-sm bg-amber-500 text-white shadow-lg hover:bg-amber-600 transition-all animate-pulse"
      >
  ...
  return (
    <div className="fixed bottom-6 left-60 z-[9999] w-72 max-h-[300px] overflow-hidden rounded-xl bg-[#0a1628] border border-amber-500/30 shadow-2xl">
      {/* Header */}
