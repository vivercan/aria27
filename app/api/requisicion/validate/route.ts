...
export async function GET(request: Request) {
  ...
  if (action === "APROBADA") {
    ...
    await resend.emails.send({
      from: "ARIA27 <noreply@mail.jjcrm27.com>", to: "juanviverosv@gmail.com",
