...
import { LayoutDashboard, HardHat, Users, ShoppingCart, PieChart, Truck, FileText, Settings } from "lucide-react"
...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="flex h-screen overflow-hidden bg-transparent">
      {/* Sidebar / Dock */}
      <aside className="w-64 flex flex-col m-4 bg-white/5 backdrop-blur-2xl border border-white/10 rounded-3xl shadow-2xl">
        <div className="p-8">
      ...
      {/* Main Content Area */}
      <main className="flex-1 my-4 mr-4 bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl overflow-hidden relative shadow-2xl">
