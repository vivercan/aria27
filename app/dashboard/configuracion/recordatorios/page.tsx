    ...
    <div className="flex flex-col gap-4 p-6 h-full overflow-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
        <div className="p-4 rounded-2xl bg-white/[0.03] border border-white/[0.06]">
          ...
          <p className="text-xs text-[#7f93b0]">Total</p>
        </div>
        <div className="p-4 rounded-2xl bg-white/[0.03] border border-white/[0.06]">
      ...
      <div className="flex-1 overflow-auto rounded-2xl border border-white/[0.06] bg-white/[0.02]">
        <div className="grid grid-cols-[1fr_100px_120px_100px_100px_50px] gap-2 px-4 py-3 border-b border-white/[0.08] bg-white/[0.04] text-[11px] font-medium uppercase text-white/50 sticky top-0">
      ...
      {showForm && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 " onClick={() => setShowForm(false)}>
          <div className="bg-[#0f172a] border border-white/[0.08] rounded-2xl p-6 w-full max-w-md shadow-2xl" onClick={e => e.stopPropagation()}>
            ...
            <div className="flex justify-end gap-3 mt-4">
              <button onClick={() => setShowForm(false)} className="px-4 py-2 rounded-xl bg-white/[0.04] text-sm hover:bg-white/[0.06]">Cancelar</button>
