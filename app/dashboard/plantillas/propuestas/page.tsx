...
import { ArrowLeft, Presentation, Construction } from "lucide-react";
    ...
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div className="p-3 rounded-xl bg-slate-500/20">
          <Presentation className="w-6 h-6 text-slate-400" />
        </div>
        <div>
          <h1 className="text-2xl font-bold text-white">Propuestas</h1>
          <p className="text-slate-400 text-sm">Plantillas de propuestas</p>
        </div>
      </div>
