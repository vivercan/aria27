...
import {
  Library, FileText, Presentation, ClipboardList, ChevronRight,
} from "lucide-react";
...
const grupos: { label: string; modulos: ModuleItem[] }[] = [
  {
    label: "Biblioteca",
    modulos: [
      { title: "Plantillas",  description: "Biblioteca de plantillas de documentos reutilizables.", href: "/dashboard/plantillas/biblioteca", icon: Library,       accent: PURPLE, hero: true },
      { title: "Documentos",  description: "Centro de documentación corporativa.",                  href: "/dashboard/plantillas/documentos", icon: FileText,      accent: PURPLE },
      { title: "Propuestas",  description: "Paquetes de licitación y propuestas técnicas.",         href: "/dashboard/plantillas/propuestas", icon: Presentation,  accent: PURPLE },
      { title: "Órdenes",     description: "Formatos de órdenes de compra y contratos.",            href: "/dashboard/plantillas/ordenes",    icon: ClipboardList, accent: PURPLE },
    ],
  },
];
    ...
    >
      ...
      <div className="flex-shrink-0 rounded-xl px-5 py-3" style={{ marginBottom: "24px", background: "linear-gradient(180deg, #123E92 0%, #103A86 100%)", borderBottom: "1px solid rgba(150,180,230,0.10)" }}>
        <div className="flex items-baseline gap-3.5">
          <h1 style={{ fontSize: "30px", fontWeight: 800, letterSpacing: "-0.035em", color: "#F4F8FF", lineHeight: 1 }}>Plantillas</h1>
          <span style={{ color: "rgba(145,175,225,0.35)", fontSize: "15px" }}>·</span>
          <span style={{ fontSize: "14px", fontWeight: 500, color: "rgba(214,228,255,0.70)" }}>Documentos, formatos y propuestas</span>
        </div>
      </div>
