...
import { ArrowLeft, FileText, Search, Plus, DollarSign, CheckCircle2, Clock, AlertTriangle } from "lucide-react";
...
export default function FacturacionPage() {
  ...
  async function guardar() {
    ...
    const { count, error: facturasErr } = await supabase.from("facturas").select("*", { count: "exact", head: true });
    if (facturasErr) console.error("Error loading facturas:", facturasErr.message);
