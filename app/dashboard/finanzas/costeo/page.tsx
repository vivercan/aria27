...
import { ArrowLeft, PieChart, Construction } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-white">Costeo por Proyecto</h1>
          <p className="text-slate-400 text-sm">Control de costos por obra</p>
        </div>
      </div>
