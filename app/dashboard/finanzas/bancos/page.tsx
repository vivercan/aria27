...
export default function BancosPage() {
  ...
  async function eliminar(id: string) {
    ...
    const { error: cuentasBancariaserr } = await supabase.from("cuentas_bancarias").delete().eq("id", id);
    if (cuentasBancariaserr) console.error("Error deleting cuentas_bancarias:", cuentasBancariaserr.message);
    loadData();
  }
