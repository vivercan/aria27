...
const modules = [
  ...
  { title: "Configuración", description: "Ajustes del módulo.", icon: Settings, href: "/dashboard/requisiciones/Configuración", color: "from-slate-500 to-slate-600", glowColor: "rgba(100,116,139,0.2)" },
];
