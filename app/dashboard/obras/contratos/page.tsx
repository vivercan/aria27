...
export default function ContratosPage() {
  ...
  async function guardar() {
    ...
    const { count, error: contratosErr } = await supabase.from("contratos").select("*", { count: "exact", head: true });
    if (contratosErr) console.error("Error loading contratos:", contratosErr.message);
