...
const submodules = [
  { title: "Nueva Requisición", description: "Crear solicitud de materiales.", icon: FilePlus, href: "/dashboard/supply-desk/requisitions/new", color: "from-emerald-500 to-emerald-600" },
  { title: "Estatus de Requisiciones", description: "Monitor de solicitudes.", icon: ListChecks, href: "/dashboard/supply-desk/requisitions/status", color: "from-blue-500 to-blue-600" },
  { title: "Autorizar Requisiciones", description: "Aprobar solicitudes pendientes.", icon: ShieldCheck, href: "/dashboard/supply-desk/requisitions/authorize", color: "from-amber-500 to-amber-600" },
  { title: "Compras", description: "Gestionar cotizaciones.", icon: ShoppingCart, href: "/dashboard/supply-desk/requisitions/purchasing", color: "from-purple-500 to-purple-600" },
  { title: "Órdenes de Compra", description: "Órdenes autorizadas.", icon: ClipboardList, href: "/dashboard/supply-desk/requisitions/orders", color: "from-cyan-500 to-cyan-600" },
];
