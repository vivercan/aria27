...
const SCOPE = "admin:estimaciones";
    ...
    <div className="aria-bg-canon h-full flex flex-col overflow-hidden">
      <div className="flex items-center gap-3 mb-4 flex-shrink-0">
        ...
        <div className="flex-1">
          <h1 className="text-2xl font-bold text-white">Estimaciones</h1>
          <p className="text-xs text-[#7f93b0]">Carpeta unificada Admin + Obras. Estimaciones por obra/cliente.</p>
        </div>
      </div>
        ...
        <div className="col-span-8 lg:col-span-9 min-h-0 overflow-y-auto">
          {selected ? (
            <EntityFolder
              ...
              title={`Estimaciones - ${selectedName}`}
            />
          ) : (
