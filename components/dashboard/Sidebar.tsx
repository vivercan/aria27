...
const modules = [
  ...
  },
  {
    name: "Abasto",
    icon: Package,
    href: "/dashboard/abasto",
    color: "text-cyan-400",
    submodules: [
      { name: "Requisiciones", href: "/dashboard/abasto/requisiciones" },
      { name: "Proveedores", href: "/dashboard/abasto/proveedores" },
      { name: "Productos", href: "/dashboard/abasto/productos" },
      { name: "Cotizaciones", href: "/dashboard/abasto/cotizaciones" },
      { name: "Compras", href: "/dashboard/abasto/compras" },
      { name: "Entregas", href: "/dashboard/abasto/entregas" },
      { name: "Pagos", href: "/dashboard/abasto/pagos" },
      { name: "Prospección", href: "/dashboard/abasto/prospeccion" },
    ],
  },
  {
    name: "Finanzas",
