...
const modules = [
  ...
  },
  {
    ...
    submodules: [
      ...
      { name: "Correo", href: "/dashboard/configuracion/correo" },
      { name: "Recordatorios", href: "/dashboard/configuracion/recordatorios" },
      { name: "Versiones", href: "/dashboard/configuracion/versiones" },
      { name: "General", href: "/dashboard/configuracion/general" },
    ],
  },
];
