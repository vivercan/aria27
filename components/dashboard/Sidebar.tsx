...
const modules = [
  ...
  },
  {
    name: "Configuración",
    icon: Settings,
    href: "/dashboard/Configuraciónuracion",
    color: "text-slate-400",
    submodules: [
      { name: "Maestros", href: "/dashboard/Configuraciónuracion/maestros" },
      { name: "Accesos", href: "/dashboard/Configuraciónuracion/accesos" },
      { name: "Integraciones", href: "/dashboard/Configuraciónuracion/integraciones" },
      { name: "Alertas", href: "/dashboard/Configuraciónuracion/alertas" },
      { name: "Correo", href: "/dashboard/Configuraciónuracion/correo" },
      { name: "Recordatorios", href: "/dashboard/Configuraciónuracion/recordatorios" },
      { name: "Versiones", href: "/dashboard/Configuraciónuracion/versiones" },
      { name: "General", href: "/dashboard/Configuraciónuracion/general" },
    ],
  },
];
